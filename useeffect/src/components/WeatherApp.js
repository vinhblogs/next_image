        ...
        <div className="additional-section">
            <div className="row">
                <div className="item">
                    ...
                    <div className="value sunrise">5</div>
                </div>
                <div className="item">
                    <div className="lable">mặt trời lặn</div>
                    <div className="value sunset">23</div>
                </div>
            ...
            <div className="row">
                <div className="item">
                    ...
                    <div className="value"><span className="humidity">4</span>%</div>
                </div>
                <div className="item">
                    <div className="lable">gió</div>
                    <div className="value"><span className="wind-speed">23</span>km/h</div>
                </div>
